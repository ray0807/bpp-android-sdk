...
JNIEXPORT jbyteArray JNICALL Java_com_xmtj_bgpdecoder_DecoderWrapper_decodeBuffer
        (JNIEnv *env, jclass class, jbyteArray encBuffer, jint encBufferSize) {
    jboolean isCopy;
...
static JNINativeMethod method_table[] = {
        {"fetchDecodedBufferSize", "([BI)I",  (void *) Java_com_xmtj_bgpdecoder_DecoderWrapper_fetchDecodedBufferSize},
        {"decodeBuffer",           "([BI)[B", (void *) Java_com_xmtj_bgpdecoder_DecoderWrapper_decodeBuffer},
};
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    if ((*vm)->GetEnv(vm, (void **) &env, JNI_VERSION_1_6) != JNI_OK) {
        ...
        jclass clazz = (*env)->FindClass(env, "com/xmtj/bgpdecoder/DecoderWrapper");
        if (clazz) {
